        ...
        <div>
            <div class="card">
                ...
                <div class="fg">
                    ...
                    <textarea name="conteudo" class="fc" id="inp-conteudo" required placeholder="Escreva o texto do post e use os botões acima para formatação."><?= htmlspecialchars($conteudo) ?></textarea>
        ...
        <div>
            ...
            <div class="card">
                ...
                <div class="fg">
                    ...
                    <input type="text" name="imagem_destaque" id="inp-imagem" class="fc" value="<?= htmlspecialchars($imagem_destaque) ?>" placeholder="/assets/uploads/blog/imagem.jpg">
    ...
    btn.addEventListener('click', () => {
        ...
        if (action === 'addHeading') {
            ...
            if (start === end) {
                ...
                editorTextarea.selectionEnd = end + 17; // len(<strong></strong>)
            ...
            if (start === end) {
                ...
                editorTextarea.selectionStart = start;
                editorTextarea.selectionEnd = end + 9; // len(<em></em>)
                editorTextarea.focus();
            }
        }
    });
