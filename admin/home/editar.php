...
/* ── Upload de imagens (textarea multi) ── */
.up-imgs-box{margin-top:10px;padding:14px;border:1px solid var(--border);border-radius:8px;background:#fff}
.up-imgs-box .up-imgs-label{font-size:12px;color:var(--muted);margin-bottom:8px;display:flex;align-items:center;gap:5px}
